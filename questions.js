...
function loadQuestion(index) {
  ...
  randomQuestion.options.forEach(function(option, idx) {
    ...
    // Create a wrapper to contain the image and radio button
    var wrapper = document.createElement("div");
    wrapper.style.display = "flex";
    wrapper.style.alignItems = "center";

    // Create a label to associate the input with an image or text
    var label = document.createElement("label");
    label.style.marginLeft = "";
    label.style.fontSize="2rem" // Space between radio button and image/text
    ...
    if (option.endsWith('.png') || option.endsWith('.jpg') || option.endsWith('.jpeg') || option.endsWith('.gif')) {
      ...
      img.style.maxHeight = "170px"; // Adjust as needed
